...
#include <Hash.h>
#elif defined(ESP32)
/* Prefer the hwcrypto header when available; on some cores (ESP32-S3)
    the esp_sha API is provided via mbedtls port headers. Use the best
    available one via __has_include to remain portable across cores. */
#if defined(__has_include)
#  if __has_include(<hwcrypto/sha.h>)
#    include <hwcrypto/sha.h>
#    define WEBSOCKETS_HAVE_ESP_SHA 1
#  elif __has_include(<mbedtls/port/include/sha/sha_parallel_engine.h>)
#    include <mbedtls/port/include/sha/sha_parallel_engine.h>
#    define WEBSOCKETS_HAVE_ESP_SHA 1
#  elif __has_include(<mbedtls/port/include/sha/sha_dma.h>)
#    include <mbedtls/port/include/sha/sha_dma.h>
#    define WEBSOCKETS_HAVE_ESP_SHA 1
#  else
