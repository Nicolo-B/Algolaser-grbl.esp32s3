...
#define CONNECT_TO_SSID  "Balzoni Vittore Internal"
#define SSID_PASSWORD  "[BV142rd]"
//CONFIGURE_EYECATCH_BEGIN (DO NOT MODIFY THIS LINE)
// Enable Bluetooth except when targeting ESP32-S3 (missing BT Classic SPP)
#if !defined(CONFIG_IDF_TARGET_ESP32S3) && !defined(ARDUINO_ESP32S3_DEV)
#    define ENABLE_BLUETOOTH  // enable bluetooth
#endif

// SD card support disabled because the slot is physically damaged
