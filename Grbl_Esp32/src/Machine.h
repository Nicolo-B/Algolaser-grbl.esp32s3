...
// !!! For actual use, change the line below to match your board.
// For the Algolaser DIY mini 10W, use the dedicated configuration:
#    include "Machines/algolaser.h"

// !!! For reference, other boards can be selected here:
